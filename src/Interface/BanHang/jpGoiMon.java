...
public class jpGoiMon extends javax.swing.JPanel {
    ...
    public void fillDsMon(int mahd){
        ...
        if(order != null){
            ...
            for(int i=0;i<order.size();i++){
                ...
                pn[i].setLayout(fl);
                pn[i].setPreferredSize(new Dimension(350, 50));
                pn[i].setMaximumSize(new Dimension(350, 50));
                pn[i].setMinimumSize(new Dimension(350, 50));

                JLabel tenmon =new JLabel(order.get(i).GetTenMon());
                tenmon.setMinimumSize(new Dimension(185, 40));
                tenmon.setPreferredSize(new Dimension(185, 40));
                tenmon.setMaximumSize(new Dimension(185, 40));
                tenmon.setForeground(Color.decode("#001a66"));
                pn[i].add(tenmon);

                JLabel giamon =new JLabel(String.valueOf(chuyentien.format(order.get(i).GetGia())));
                giamon.setMinimumSize(new Dimension(65, 40));
                giamon.setPreferredSize(new Dimension(65, 40));
                giamon.setMaximumSize(new Dimension(65, 40));
                giamon.setForeground(Color.decode("#ff0000"));
                pn[i].add(giamon);
                
                JLabel sluong =new JLabel(String.valueOf(order.get(i).GetSoLuong())+" "+ order.get(i).GetDVT());
                sluong.setMinimumSize(new Dimension(40, 40));
                sluong.setPreferredSize(new Dimension(40, 40));
                sluong.setMaximumSize(new Dimension(40, 40));
                sluong.setForeground(Color.decode("#008000"));
                pn[i].add(sluong);
                ...
                JLabel lbl = new JLabel("X",JLabel.CENTER);
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/food_bar_64px.png"))); // NOI18N
        ...
        jLabel7.setForeground(new java.awt.Color(0, 135, 135));
