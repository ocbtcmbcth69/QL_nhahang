...
//        jTabbedKV.add(scJp);
        ...
        for (int i = 0; i < arrBanAll.size(); i++) {
            btn[i] = new JButton();
                ...
                btn[i].setBackground(Color.decode("#06D6A0"));
                ...
                if(arrBanAll.get(i).GetTrangThai().equals("Đang phục vụ")){
                    btn[i].setBackground(Color.decode("#EF476F"));
                }
                if(arrBanAll.get(i).GetTrangThai().equals("Đã đặt trước")){
                    btn[i].setBackground(Color.decode("#FFD166"));
                }
                btn[i].setPreferredSize(new Dimension(93, 80));
    ...
    private void initComponents() {
        ...
        jLabel6.setBackground(new java.awt.Color(239, 71, 111));
        jLabel6.setText("           ");
        ...
        jLabel8.setBackground(new java.awt.Color(255, 209, 102));
        jLabel8.setText("           ");
